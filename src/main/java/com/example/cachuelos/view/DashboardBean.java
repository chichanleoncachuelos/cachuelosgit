...
public class DashboardBean implements Serializable {
	...
	private void executeDashboardQuery() {
		...
		for (Zone zone2 : listZone) {
			...
			Object data;
			float conta = zone2.getCachCount();
			String strTmp = "La Zona: " + zone2.getName() + " tiene "
					+ zone2.getCachCount() + " cachuelos(" + (conta / total)
					* 100 + ")%";
			data = (Object) strTmp;
			circle.setData(data);
	...
	public Converter getConverter() {
		...
		final DashboardBean ejbProxy = this.sessionContext
				.getBusinessObject(DashboardBean.class);
