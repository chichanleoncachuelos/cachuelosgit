...
@Stateful
@ConversationScoped
public class CommentratingtypeBean implements Serializable
{
   ...
   public Converter getConverter()
   {
      ...
      final CommentratingtypeBean ejbProxy = this.sessionContext.getBusinessObject(CommentratingtypeBean.class);
