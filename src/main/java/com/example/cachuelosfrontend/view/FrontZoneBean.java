...
@Stateful
@ConversationScoped
public class FrontZoneBean implements Serializable
{
   ...
   public List<Zone> getAll()
   {
      ...
      CriteriaQuery<Zone> criteria = this.entityManager
            .getCriteriaBuilder().createQuery(Zone.class);
   ...
   public Converter getConverter()
   {
      ...
      final FrontZoneBean ejbProxy = this.sessionContext.getBusinessObject(FrontZoneBean.class);
