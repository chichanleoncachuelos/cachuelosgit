 ...
 * <p>
 * This class provides CRUD functionality for all Userlocationbytime entities. It focuses
...
@Stateful
@ConversationScoped
public class FrontUserlocationbytimeBean implements Serializable
{
   ...
   public String update()
   {
      ...
      try
      {
         ...
         else
         {
            ...
            return "view?faces-redirect=true&id=" + this.userlocationbytime.getIdUserLocationByTime();
         }
      }
      catch (Exception e)
      {
   ...
   public void paginate()
   {
      ...
      Root<Userlocationbytime> root = countCriteria.from(Userlocationbytime.class);
      ...
      CriteriaQuery<Userlocationbytime> criteria = builder.createQuery(Userlocationbytime.class);
      root = criteria.from(Userlocationbytime.class);
      TypedQuery<Userlocationbytime> query = this.entityManager.createQuery(criteria
   ...
   /*
    * Support listing and POSTing back Userlocationbytime entities (e.g. from inside an
    * HtmlSelectOneMenu)
    */
   ...
   public List<Userlocationbytime> getAll()
   {
      ...
      return this.entityManager.createQuery(
            criteria.select(criteria.from(Userlocationbytime.class))).getResultList();
   }
   ...
   public Converter getConverter()
   {
      ...
      final FrontUserlocationbytimeBean ejbProxy = this.sessionContext.getBusinessObject(FrontUserlocationbytimeBean.class);
      ...
      return new Converter()
      {
               ...
               UIComponent component, Object value)
         {
            ...
            return String.valueOf(((Userlocationbytime) value).getIdUserLocationByTime());
         }
      };
   }
