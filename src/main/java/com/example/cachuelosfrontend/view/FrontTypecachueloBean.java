...
@Stateful
@ConversationScoped
public class FrontTypecachueloBean implements Serializable
{
   ...
   public Converter getConverter()
   {
      ...
      final FrontTypecachueloBean ejbProxy = this.sessionContext.getBusinessObject(FrontTypecachueloBean.class);
